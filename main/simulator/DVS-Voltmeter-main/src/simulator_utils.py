...
@Note    :   Third-party code from DVS-Voltmeter. Sample events by alternating between polarity selection and timestamp sampling, in Algorithm 1, Section 4
...
def event_generation(ep_on, ep_off, c, sigma, delta_vd_legacy, start_t, end_t, x=None, y=None):
    ...
    still_possible_events = delta_t_2_ends < 0
